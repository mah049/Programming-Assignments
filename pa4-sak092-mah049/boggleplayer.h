...
class BogglePlayer : public BaseBogglePlayer {
  public:
    ...
    //debug
    void print(unsigned int rows, unsigned int cols);

    //for is on board
    void getNeighbors(int current, std::stack<BoardPos> * myStack);

    // for gavw
    void getWords(unsigned int row, unsigned int col, LexNode * currNode, 
